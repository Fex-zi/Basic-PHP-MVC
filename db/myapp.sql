...
(1, 'Ifeanyi Ojukwu', 'fexzi87@gmail.com'),
(2, 'Paige Loudon', 'Paige@gmail.com');
...
--
ALTER TABLE `notes`
  ADD CONSTRAINT `notes_fk_key` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
